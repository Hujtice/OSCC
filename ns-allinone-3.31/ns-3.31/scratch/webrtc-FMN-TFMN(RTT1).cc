...
void RunSingleTraceSimulation(const std::string& trace_file, int index, int total, 
    ...
    std::string command = "./waf --run \"scratch/webrtc-TFMN(RTT1) --m=simu --topo=change --it=" + 
...
// ./waf --run "scratch/webrtc-FMN-TFMN(RTT1) --dir /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/traces/traces/AItrans/ --video_trace /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/video_trace/AsianCup_China_Uzbekistan/frame_trace_0 --all --custom"