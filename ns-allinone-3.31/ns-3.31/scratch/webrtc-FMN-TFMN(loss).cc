...
void RunSingleTraceSimulation(const std::string& trace_file, int index, int total, 
    ...
    std::string command = "./waf --run \"scratch/webrtc-TFMN(loss) --m=simu --topo=change --it=" + 
                         instance_name + " --trace=" + trace_file + 
                         " --mb=6 --ls=" + std::to_string(loss_rate) + " --mu=" + std::to_string(bandwidth_scale_factor);
...
void RunCustomBatchProcessing(const std::vector<std::string>& trace_files, const std::string& video_trace_file = "") {
    ...
    std::vector<double> custom_mu_values  = {0.5,1};
...
// ./waf --run "scratch/webrtc-FMN-TFMN(S-D) --dir /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/traces/traces/AItrans/ --video_trace /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/video_trace/AsianCup_China_Uzbekistan/frame_trace_6 --all --custom"
// ./waf --run "scratch/webrtc-FMN-TFMN(loss) --dir /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/traces/traces/AItrans --video_trace /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/video_trace/AsianCup_China_Uzbekistan/frame_trace_6 --all --custom"
// nohup ./waf --run "scratch/webrtc-FMN-TFMN(loss) --dir /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/traces/traces/AItrans/ --video_trace /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/video_trace/AsianCup_China_Uzbekistan/frame_trace_6 --all --custom" > /dev/null 2>&1 &