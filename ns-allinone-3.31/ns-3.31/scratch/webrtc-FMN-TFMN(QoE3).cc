...
void RunSingleTraceSimulation(const std::string& trace_file, int index, int total, 
    ...
    std::string command = "./waf --run \"scratch/webrtc-TFMN(QoE3) --m=simu --topo=change --it=" + 
...
// ./waf --run "scratch/webrtc-FMN-TFMN(QoE3) --oscc --dir /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/traces/traces/AItrans/ --all --video_trace /home/hjt/OSCC/ns-allinone-3.31/ns-3.31/video_trace/AsianCup_China_Uzbekistan/frame_trace_4" > webrtc_ns3.log 2>&1