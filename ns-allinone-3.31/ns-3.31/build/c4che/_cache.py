...
CC = ['/usr/bin/clang']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-unused-parameter', '-O0', '-ggdb', '-g3', '-Wall', '-Wno-unused-parameter', '-Wno-unused-local-typedefs', '-Wno-potentially-evaluated-expression', '-std=c++11', '-std=c++14', '-I/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src', '-I/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src/third_party/abseil-cpp', '-Wno-unused-const-variable', '-Wno-unused-private-field']
...
CXX = ['/usr/bin/clang++']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-unused-parameter', '-Wno-unused-local-typedefs', '-Wno-potentially-evaluated-expression', '-std=c++11', '-std=c++14', '-I/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src', '-I/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src/third_party/abseil-cpp', '-Wno-unused-const-variable', '-Wno-unused-private-field']
...
ENABLE_webrtc = True
EXAMPLE_DIRECTORIES = ['tcp', 'error-model', 'tutorial', 'udp', 'ipv6', 'matrix-topology', 'socket', 'energy', 'udp-client-server', 'stats', 'traffic-control', 'realtime', 'naming', 'wireless', 'routing']
...
INCLUDES_libwebrtc = ['/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src', '/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src/third_party/abseil-cpp']
...
LIBPATH_ST = '-L%s'
LIBPATH_libwebrtc = ['/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/src/ex-webrtc/webrtc/src/out/m84/obj']
LIB_BOOST = ['boost_system', 'boost_signals', 'boost_filesystem']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
LIB_libwebrtc = ['webrtc']
...
VALGRIND_FOUND = True
VERSION = '3.31'
cfg_files = ['/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/build/ns3/config-store-config.h', '/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/build/ns3/core-config.h', '/home/hjt/OSCC/ns-allinone-3.31/ns-3.31/build/ns3/stats-config.h']
cprogram_PATTERN = '%s'
